...
K_max = 30; %gradient descent takes care of optimal value for K in a continuous fashion
...
sigma_init = 7; % initial sigma of gaussian filter (lower values result in more emphasis on closes neighbours)
