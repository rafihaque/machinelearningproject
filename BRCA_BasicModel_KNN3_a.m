...
% add relevant paths
clear; close all; clc;
addpath('C:/Users/heyuan0755/Documents/GitHub/machinelearningproject')
addpath('C:/Users/heyuan0755/Documents/GitHub/machinelearningproject/Codes/glmnet_matlab/glmnet_matlab/')
% turn off warnings
% warning('off','all')
...
Survival = BRCA_BasicModel.Survival +9; %add 3 to ignore negative survival
...
for trial = 1:trial_No
    ...
    if strcmp(Descent,'Beta') ==1
        Beta_star = KNN_Survival_Decend2b(X_valid,X_prototype,Alive_prototype,Alive_valid,K_star,Beta_init,Filters,Gamma_Beta,Pert_Beta,Conv_Thresh_Beta,sigma_init,'SaveProgress');
    elseif strcmp(Descent,'sigma') ==1    
        sigma_star = KNN_Survival_Decend2a(X_valid,X_prototype,Alive_prototype,Alive_valid,K_star,Beta_init,Filters,Gamma_sigma,Pert_sigma,Conv_Thresh_sigma,sigma_init,'SaveProgress');      
    end
